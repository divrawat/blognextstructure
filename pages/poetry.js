...
const poetry = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of poetry section where you can find poetry related to many things."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <p className={styles.para}>Are You Looking for best Poetry. here find the best Poetry serwer yufgs sftigswf withwiftb wrigwr
