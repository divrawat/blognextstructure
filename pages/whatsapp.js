...
const Whatsapp = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of Whatsapp section where you can find whatsapp Dp's, its features and beautiful profile pictures which you can add on whatsapp."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <h1 className={styles.heading}>Whatsapp Dp</h1>
       ...
       <p className={styles.para}>Are You Looking for best whatsapp dp. here find the best whatsapp dp serwer yufgs sftigswf withwiftb wrigwr
