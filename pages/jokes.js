...
const jokes = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of jokes section where you can find jokes related to many things."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <h1 className={styles.heading}>Jokes</h1>
       ...
       <p className={styles.para}>Are You Looking for best Jokes. here find the best Jokes serwer yufgs sftigswf withwiftb wrigwr
