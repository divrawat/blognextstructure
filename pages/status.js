...
const status = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of status section where you can find whatsapp status related to many things."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <p className={styles.para}>Are You Looking for best Status. here find the best Status serwer yufgs sftigswf withwiftb wrigwr
