...
const images = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of images section where you can find images related to many things."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <p className={styles.para}>Are You Looking for best Images. here find the best Images serwer yufgs sftigswf withwiftb wrigwr
