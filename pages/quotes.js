...
const quotes = () => {
  return (
   ...
   <Head>
   <meta charset="UTF-8"/>
  <meta name="description" content="This is the category page of quotes section where you can find quotes related to many things."/>
  ...
  <div className={styles.headerAd}>
   ...
   <div className={styles.categorycontent}>
       ...
       <p className={styles.para}>Are You Looking for best Quotes. here find the best Quotes serwer yufgs sftigswf withwiftb wrigwr
